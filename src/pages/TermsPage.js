  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-3xl mx-auto prose dark:prose-invert lg:prose-xl bg-white dark:bg-gray-800 p-8 rounded-xl shadow-xl">
        ...
        <p>Chào mừng bạn đến với JisuLife Vietnam! Vui lòng đọc kỹ các Điều Khoản và Điều Kiện này trước khi sử dụng trang web của chúng tôi.</p>
        ...
        <p>Dịch vụ và nội dung gốc, các tính năng và chức năng của nó là và sẽ vẫn là tài sản độc quyền của JisuLife Vietnam và các nhà cấp phép của nó. Dịch vụ được bảo vệ bởi bản quyền, nhãn hiệu và các luật khác của cả Việt Nam và các quốc gia nước ngoài.</p>

        <h2>6. Giới Hạn Trách Nhiệm</h2>
        <p>Trong mọi trường hợp, JisuLife Vietnam, cũng như giám đốc, nhân viên, đối tác, đại lý, nhà cung cấp hoặc chi nhánh của JisuLife Vietnam, sẽ không chịu trách nhiệm pháp lý cho bất kỳ thiệt hại gián tiếp, ngẫu nhiên, đặc biệt, do hậu quả hoặc trừng phạt nào, bao gồm nhưng không giới hạn, mất lợi nhuận, dữ liệu, việc sử dụng, thiện chí, hoặc các tổn thất vô hình khác, phát sinh từ (i) việc bạn truy cập hoặc sử dụng hoặc không thể truy cập hoặc sử dụng Dịch vụ...</p>
